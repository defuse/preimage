//! Standard digests, wrapping the RustCrypto implementations.
//!
...
mod tests {
    ...
    fn test_md2_hello() {
        assert_eq!(
            hex::encode(Md2.hash(b"hello").unwrap()),
    ...
    fn test_md2_emoji() {
        assert_eq!(
            hex::encode(Md2.hash("😀".as_bytes()).unwrap()),
    ...
    fn test_md4_hello() {
        assert_eq!(
            hex::encode(Md4.hash(b"hello").unwrap()),
    ...
    fn test_md4_emoji() {
        assert_eq!(
            hex::encode(Md4.hash("😀".as_bytes()).unwrap()),
            "d60c87f11ac824ea903b6d937e840081"
        );
    }
    ...
    fn test_md5_hello() {
        assert_eq!(
            hex::encode(Md5.hash(b"hello").unwrap()),
    ...
    fn test_md5_emoji() {
        assert_eq!(
            hex::encode(Md5.hash("😀".as_bytes()).unwrap()),
    ...
    fn test_sha1_hello() {
        assert_eq!(
            hex::encode(Sha1.hash(b"hello").unwrap()),
    ...
    fn test_sha1_emoji() {
        assert_eq!(
            hex::encode(Sha1.hash("😀".as_bytes()).unwrap()),
            "9c533688a979a858cbd6a43c9f91aba624651f18"
        );
    }
    ...
    fn test_sha224_empty() {
        assert_eq!(
            hex::encode(Sha224.hash(b"").unwrap()),
    ...
    fn test_sha224_hello() {
        assert_eq!(
            hex::encode(Sha224.hash(b"hello").unwrap()),
    ...
    fn test_sha224_emoji() {
        assert_eq!(
            hex::encode(Sha224.hash("😀".as_bytes()).unwrap()),
            "0965afc5f46fff2c3761b506dac6c4dcfd118e72551dc60d39cb1c1c"
        );
    }
    ...
    fn test_sha256_empty() {
        assert_eq!(
            hex::encode(Sha256.hash(b"").unwrap()),
    ...
    fn test_sha256_hello() {
        assert_eq!(
            hex::encode(Sha256.hash(b"hello").unwrap()),
    ...
    fn test_sha256_emoji() {
        assert_eq!(
            hex::encode(Sha256.hash("😀".as_bytes()).unwrap()),
    ...
    fn test_sha512_224_empty() {
        assert_eq!(
            hex::encode(Sha512_224.hash(b"").unwrap()),
    ...
    fn test_sha512_224_hello() {
        assert_eq!(
            hex::encode(Sha512_224.hash(b"hello").unwrap()),
    ...
    fn test_sha512_224_emoji() {
        assert_eq!(
            hex::encode(Sha512_224.hash("😀".as_bytes()).unwrap()),
            "d29f43fcaaf30000275e2d752992c8761e0272e52c08a4bd79fd9ec5"
        );
    }
    ...
    fn test_sha512_256_empty() {
        assert_eq!(
            hex::encode(Sha512_256.hash(b"").unwrap()),
    ...
    fn test_sha512_256_hello() {
        assert_eq!(
            hex::encode(Sha512_256.hash(b"hello").unwrap()),
    ...
    fn test_sha512_256_emoji() {
        assert_eq!(
            hex::encode(Sha512_256.hash("😀".as_bytes()).unwrap()),
            "f2e2add15f6f5ede243087b6e15f4a5b146ef724b4c58c268750b6d0be1f993d"
        );
    }
    ...
    fn test_sha3_224_empty() {
        assert_eq!(
            hex::encode(Sha3_224.hash(b"").unwrap()),
    ...
    fn test_sha3_224_hello() {
        assert_eq!(
            hex::encode(Sha3_224.hash(b"hello").unwrap()),
    ...
    fn test_sha3_224_emoji() {
        assert_eq!(
            hex::encode(Sha3_224.hash("😀".as_bytes()).unwrap()),
            "6f0d369cbc7b7947fd2d86f449358a76e4d688539d9257ecee8be29c"
        );
    }
    ...
    fn test_sha3_256_empty() {
        assert_eq!(
            hex::encode(Sha3_256.hash(b"").unwrap()),
    ...
    fn test_sha3_256_hello() {
        assert_eq!(
            hex::encode(Sha3_256.hash(b"hello").unwrap()),
    ...
    fn test_sha3_256_emoji() {
        assert_eq!(
            hex::encode(Sha3_256.hash("😀".as_bytes()).unwrap()),
            "0f2a376a2af79037549328fa8f76fc6c41b97ff3c10107d7297d0339e3380e3c"
        );
    }
    ...
    fn test_ripemd128_empty() {
        assert_eq!(
            hex::encode(Ripemd128.hash(b"").unwrap()),
    ...
    fn test_ripemd128_hello() {
        assert_eq!(
            hex::encode(Ripemd128.hash(b"hello").unwrap()),
            "789d569f08ed7055e94b4289a4195012"
        );
    }
    #[test]
    fn test_ripemd128_emoji() {
        assert_eq!(
            hex::encode(Ripemd128.hash("😀".as_bytes()).unwrap()),
            "394b80f545f4e77a8e6e300a826bced9"
        );
    }
    ...
    fn test_ripemd160_empty() {
        assert_eq!(
            hex::encode(Ripemd160.hash(b"").unwrap()),
    ...
    fn test_ripemd160_hello() {
        assert_eq!(
            hex::encode(Ripemd160.hash(b"hello").unwrap()),
    ...
    fn test_ripemd160_emoji() {
        assert_eq!(
            hex::encode(Ripemd160.hash("😀".as_bytes()).unwrap()),
            "22daaf01b6c6700c5069a76c9a8e4b3f3ec62fc2"
        );
    }
    ...
    fn test_ripemd256_empty() {
        assert_eq!(
            hex::encode(Ripemd256.hash(b"").unwrap()),
    ...
    fn test_ripemd256_hello() {
        assert_eq!(
            hex::encode(Ripemd256.hash(b"hello").unwrap()),
    ...
    fn test_ripemd256_emoji() {
        assert_eq!(
            hex::encode(Ripemd256.hash("😀".as_bytes()).unwrap()),
            "bfdf1e152e774c3dfab03692c79ed2b7590981be150e8f912ca7a118d2b722a9"
        );
    }
    ...
    fn test_ripemd320_empty() {
        assert_eq!(
            hex::encode(Ripemd320.hash(b"").unwrap()),
    ...
    fn test_ripemd320_hello() {
        assert_eq!(
            hex::encode(Ripemd320.hash(b"hello").unwrap()),
    ...
    fn test_ripemd320_emoji() {
        assert_eq!(
            hex::encode(Ripemd320.hash("😀".as_bytes()).unwrap()),
            "d9017c2c6c5fa63364037891884b75cc3224eb32f288e794acacfb910a2ac0d93909e1ff281bc378"
        );
    }
    ...
    fn test_gost_empty() {
        assert_eq!(
            hex::encode(Gost94Test.hash(b"").unwrap()),
    ...
    fn test_gost_hello() {
        assert_eq!(
            hex::encode(Gost94Test.hash(b"hello").unwrap()),
    ...
    fn test_gost_emoji() {
        assert_eq!(
            hex::encode(Gost94Test.hash("😀".as_bytes()).unwrap()),
            "131b2dacc0532144e11c423ce25128d626e0458be42dc2cd94f95423a836bbee"
        );
    }
    ...
    fn test_gost_crypto_empty() {
        assert_eq!(
            hex::encode(Gost94CryptoPro.hash(b"").unwrap()),
    ...
    fn test_gost_crypto_hello() {
        assert_eq!(
            hex::encode(Gost94CryptoPro.hash(b"hello").unwrap()),
    ...
    fn test_gost_crypto_emoji() {
        assert_eq!(
            hex::encode(Gost94CryptoPro.hash("😀".as_bytes()).unwrap()),
            "851e0b715e5a36c4fa6557541540c3893473857ee9f89803a614967aaca6896b"
        );
    }
}
